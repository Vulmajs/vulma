<template>
    <div class="v-table" :class="{ 'is-loading': loading }">
        <v-table-mobile-sort
...
<script>
    ...
    import { Checkbox as VCheckbox } from '../checkbox'
    import VPagination from '../pagination'
    import VIcon from '../icon'

    import VTableMobileSort from './TableMobileSort'
    import VTableColumn from './TableColumn'
