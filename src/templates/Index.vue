<template>
  <component :is="type" class="index">
    ...
    <wrapper>
      ...
      <text-style><a href="https://vulmajs.com">VulmaJs Design System</a> is an open-source tool for building web apps with Vue.js. It provides you and your team a set of organized tools, patterns &amp; practices. It works as the foundation for your application development.</text-style>
    </wrapper>
  </component>
</template>
