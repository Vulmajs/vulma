<template>
    <form
        ...
        <button class="button is-text is-small">
            <span>CodePen</span>
            <v-icon icon="open-in-new" size="is-small"/>
        </button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                externalScripts: [
                    ...
                    'https://unpkg.com/vulmajs'
                ],
                externalStyles: [
                    'https://unpkg.com/vulmajs/lib/vulmajs.min.css',
        ...
        computed: {
            data() {
                return JSON.stringify({
                    title: `${this.$route.meta.title} ${this.title ? this.title.toLowerCase() : ''} - VulmaJs example`,
                    tags: ['vulmajs', 'vue', 'bulma'],
        ...
        methods: {
            getHtml() {
                ...
                html = html.replace(/src="static/g, 'src="https://vulmajs.com/static')
