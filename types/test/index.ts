import { Dialog, LoadingProgrammatic, ModalProgrammatic, Snackbar, Toast, VulmajsConfig } from "../index";
import Vulmajs from "../index";
import Vue from "vue";
...
app.$dialog.alert("Testing VulmaJs Typescript Typings");
app.$dialog.alert({
